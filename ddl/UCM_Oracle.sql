...
BEGIN
    ...
    IF TABLECHECKERFLAG = 0 THEN
        EXECUTE IMMEDIATE 'CREATE TABLE STUDENTS(ID NUMBER NOT NULL ENABLE,
                ...
                SCORES  VARCHAR2(64) NULL,
                CONCENTRATION_ID NUMBER NOT NULL,
                STUDENTSTATUS VARCHAR2(64) NOT NULL,
                STUDENTSTATUS_DATE VARCHAR2(64) NOT NULL,
                STATUS VARCHAR2(64) NOT NULL,
                TESTDETAILS CLOB,
                ACCEPTEDCODEOFCONDUCT VARCHAR2(64) NOT NULL,
                CREATED_DATE TIMESTAMP(6) NOT NULL,
...
BEGIN
    ...
    IF TABLECHECKERFLAG = 0 THEN
        EXECUTE IMMEDIATE 'CREATE TABLE ADVISORS(ID NUMBER NOT NULL ENABLE,
                    ...
                    CONSTRAINT ADVISOR_CON_ID_FK FOREIGN KEY(CONCENTRATION_ID) REFERENCES CONCENTRATIONS(ID) ON DELETE CASCADE)';
    END IF;
END;
/
DECLARE
