...
<html lang="en">
            ...
            <div id="studentQuestionnairesFormTpl">
                ...
                <div class="form-group">
                    <div class="col-sm-12 text-center">
                        <label class="checkbox-inline"><input type="checkbox" value="no" name="codeOfConduct">Accept Code of Cunduct
                            <a href="javascript:void(0);" onclick="onViewCodeOfConductClick()"
                               title="Viwe Code Of Conduct">
                                View
                            </a>
                        </label>
                    </div>
                ...
                <nav id="appNavBar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active" itemId="QUESTIONNAIRES">
                            <a href="javascript:void(0);" onclick="onStudentMainNavItemClick('QUESTIONNAIRES')"
                               title="Questionnaire">
                                Questionnaire
                            </a>
                        </li>
    ...
    <script>
        ...
        function doOnLoad() {
            ...
            loginUser = getStudentByLoginId(loginId);
