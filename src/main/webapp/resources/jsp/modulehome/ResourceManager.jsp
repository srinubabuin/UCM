...
<html lang="en">
    <head>
        ...
        <script src="../../JavaScript/app/resourcemanager/ResourceManager.js"></script>        
    ...
    <script>
        ...
        var resourceManagerLytObj;
        function doOnLoad() {
            resourceManagerLytObj = getMainLayoutObj("RESOURCEMANAGER");
            loadResourceManagerLyt(resourceManagerLytObj.domObj);
