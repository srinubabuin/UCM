...
public class UserLoginServiceImpl implements UserLoginService {
    ...
    public int modifyUser(AppUser appUser) {
        ...
        try {
            int pos = 1;
            con = AppConnectionPool.getConnection();
            pstm = con.prepareStatement(AppQueryReader.getDBQuery("com.ucm.services.impl.userloginservice.modifyuser"));
            pstm.setString(pos, appUser.getPassword());
            pstm.setString(++pos, appUser.getLoginId());
    ...
    public int deleteUser(String loginId) {
        ...
        try {
            int pos = 1;
            con = AppConnectionPool.getConnection();
            pstm = con.prepareStatement(AppQueryReader.getDBQuery("com.ucm.services.impl.userloginservice.deleteuser"));
